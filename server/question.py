...
class check_ppt(web.RequestHandler):
    ...
    def gen_cmd(self, url, PPV, ppv, fmt):
        return """\
curl 'http://owa.okjiaoyu.cn/p/ppt/view.svc/jsonAnonymous/GetPresentation'\
 ...
 -H 'Accept: */*'\
 -H 'Referer: http://owa.okjiaoyu.cn/p/PowerPointFrame.aspx?PowerPointView=""" + PPV + """&ui=zh%2DCN&rs=zh%2DCN&WOPISrc=http%3A%2F%2Fowa%2Eokjiaoyu%2Ecn%2Foh%2Fwopi%2Ffiles%2F%40%2FwFileId%3FwFileId%3D""" + url + """&access_token=1&access_token_ttl=0'\
 -H 'X-UserType: WOPI'\
 -H 'DNT: 1'\
 -H 'X-xhr: 1'\
 --data-binary '{"presentationId":"WOPIsrc=http%3A%2F%2Fowa%2Eokjiaoyu%2Ecn%2Foh%2Fwopi%2Ffiles%2F%40%2FwFileId%3FwFileId%3D""" + url + """&access_token=1&access_token_ttl=0&z=990754cd942b9109d25fa50b9e29235bc35783e1a4b4ab3dde8b3b3f41edbe22","powerpointView":""" + ppv + ""","format":""" + fmt + """}'\
 --compressed"""
